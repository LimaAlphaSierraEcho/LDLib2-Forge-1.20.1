...
> Unofficial Forge 1.20.1 port of [Low-Drag-MC/LDLib2](https://github.com/Low-Drag-MC/LDLib2).
>
...
[![Forge](https://img.shields.io/badge/Forge-47.x-E04E14?style=for-the-badge)](https://files.minecraftforge.net/net/minecraftforge/forge/index_1.20.1.html)
...
The original LDLib2 project is published to the FirstDark Maven snapshots repository for modern NeoForge versions.

This Forge 1.20.1 port currently builds from source. Use the generated jar from `build/libs` after running:

```powershell
.\gradlew.bat build
```

Original NeoForge integration example:
...
ldlib2_version=2.2.28-forge-1.20.1
```
...
LDLib2 is not a small patch over LDLib. It removes old systems and rebuilds the core architecture. The upstream project targets modern NeoForge releases; this repository adapts that work to Forge `1.20.1`.
